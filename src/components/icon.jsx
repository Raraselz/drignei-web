export default function Icon({ href, src, alt }) {
  ...
  return (
    <div className="relative opacity-80 hover:opacity-100 transition-all hover:scale-125 ">
      <button className="absolute z-10 text-xs top-0 right-0 p-1 bg-gray-800 text-white rounded">...</button>  
      <img
